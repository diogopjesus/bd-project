...
{
    public partial class AddSubstitutionForm : Form
    {
        ...
        public AddSubstitutionForm(int hid, int aid)
        {
            InitializeComponent();
            this.hid = hid;
            this.aid = aid;
        ...
        private void AddSubstitutionForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ge.Player_in_obj = (Player)comboBox1.SelectedItem;
                ge.Player_out_obj = (Player)comboBox2.SelectedItem;
